...
function App() {
  ...
  const REDIRECT_URI = "http://localhost:3000/personalData"
  ...
  useEffect(() => {
    ...
    if(isLoadingAll == false){
      ...
      console.log("Valenz: " + getAverageValence(audioFeaturesShortTerm))
      console.log("Arousal: " + getAverageArousal(audioFeaturesShortTerm))
      console.log("Medium Term:")
      getAverageValence(audioFeaturesMediumTerm)
      getAverageArousal(audioFeaturesMediumTerm)
      console.log("Valenz: " + getAverageValence(audioFeaturesMediumTerm))
      console.log("Arousal: " + getAverageArousal(audioFeaturesMediumTerm))
      console.log("Long Term:")
      getAverageValence(audioFeaturesLongTerm)
      getAverageArousal(audioFeaturesLongTerm)     
      console.log("Valenz: " + getAverageValence(audioFeaturesLongTerm))
      console.log("Arousal: " + getAverageArousal(audioFeaturesLongTerm)) 
      ...
      <Router>
        ...
        */}
        ...
        <Routes>
          ...
          <Route path="/personalData" element={<PersonalData personalData={setPersonalData} getFavoriteTracksAudioFeaturesShortTerm={getFavoriteTracksAudioFeaturesShortTerm} getFavoriteTracksAudioFeaturesMediumTerm={getFavoriteTracksAudioFeaturesMediumTerm} getFavoriteTracksAudioFeaturesLongTerm={getFavoriteTracksAudioFeaturesLongTerm} getCurrentUsersProfile={getCurrentUsersProfile} currentUsersProfile={currentUsersProfile} token={token} readyToRender={readyToRender} linkToContinue={"/goldmsiintro"}/>}></Route>
          
          <Route path="/goldmsiintro" element={<GoldMSIntro></GoldMSIntro>}></Route>
